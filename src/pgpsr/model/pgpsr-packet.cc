...
// HELLO
//-----------------------------------------------------------------------------
HelloHeader::HelloHeader (uint64_t originPosx, uint64_t originPosy,uint64_t f_originPosx, uint64_t f_originPosy)
  : m_originPosx (originPosx),
    m_originPosy (originPosy),
    f_originPosx (f_originPosx),//
    f_originPosy (f_originPosy)//
...
HelloHeader::Serialize (Buffer::Iterator i) const
{
  ...
  i.WriteHtonU64 (f_originPosx);//
  i.WriteHtonU64 (f_originPosy);//
...
HelloHeader::Deserialize (Buffer::Iterator start)
{
  ...
  f_originPosx = i.ReadNtohU64 ();//
  f_originPosy = i.ReadNtohU64 ();//
